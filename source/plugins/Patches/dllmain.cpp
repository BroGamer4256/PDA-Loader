...
void ApplyPatches() {
	...
	const struct { void* Address; std::vector<uint8_t> Data; } patches_101[] =
	{
		//Debug
		//Why the fuck did raki remove this shit
		{ (void*)0x00535CC0,{ 0xB0, 0x01 } },
        { (void*)0x00535CD0,{ 0xB0, 0x01 } },
        { (void*)0x005A3D80,{ 0xB0, 0x01, 0xC3 } },
        { (void*)0x005DB542,{ 0x00 } },
        { (void*)0x005DB6C4,{ 0x00 } },
        { (void*)0x005DBCC8,{ 0x64, 0xA3 } },
        // Skip amMaster checks
		{ (void*)0x006FAA10,{ 0xB0, 0x01, 0xC3 } },
        // Skip pcpaOpenClient loop
        { (void*)0x008AFCE0,{ 0xC2, 0x14, 0x00 } },
        // Disable the keychip time bomb
        { (void*)0x0049C8B0,{ 0xB8, 0x01, 0x00, 0x00, 0x00, 0xC3 } },
        // *But of course we have a valid keychip*, return true
        { (void*)0x006FC420,{ 0xB0, 0x01, 0xC3 } },
        // Just completely ignore all SYSTEM_STARTUP errors
        { (void*)0x005DEC50,{ 0xC3 } },
        // Skip parts of the network check state
        { (void*)0x00705949,{ 0xE9, 0x13, 0x01, 0x00, 0x00 } },
        // Ignore SYSTEM_STARTUP Location Server checks
		{ (void*)0x007052A1,{ 0x90, 0x90 } },
        // Set the initial wait timer value to 0
        { (void*)0x00706D2E,{ 0x00, 0x00 } },
        { (void*)0x00706D50,{ 0x00, 0x00 } },
        { (void*)0x00706D67,{ 0x00, 0x00 } },
        // Always exit TASK_MODE_APP_ERROR on the first frame
        { (void*)0x005DFD0B,{ 0x90, 0x90 } },
        { (void*)0x005DFD18,{ 0x90, 0x90 } },
        // Jump past the PollInput function so we can write our own input
        { (void*)0x006FA640,{ 0xC3 } },
	...
	case 600:
		...
		break;
	case 130:
		for (size_t i = 0; i < _countof(patches_130); i++)
			InjectCode(patches_130[i].Address, patches_130[i].Data);
		break;
	case 101:
